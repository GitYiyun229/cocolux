...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'files',
    'maxSize'           => 0,
    'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'images',
    'maxSize'           => 5000000,
    'allowedExtensions' => 'webp,gif,jpeg,jpg,svg',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
