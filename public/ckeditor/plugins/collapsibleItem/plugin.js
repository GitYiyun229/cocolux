function getCollapsibleItem() {
    var collapsibleItem =
        '<div class="panel panel-default collapsible-item accordion-item" id="collapbsible-1">' +
        '   <div class="panel-heading collapsible-item-heading accordion-header" role="tab" id="headingCollapbsible">' +
        '       <h4 class="panel-title collapsible-item-title">' +
        '           <a class="collapsed accordion-button collapsible-item-title-link" role="button" data-bs-toggle="collapse" data-parent="#accordion" href="#collapseCollapbsible" aria-expanded="false" aria-controls="collapseCollapbsible"><span class="collapsible-item-title-link-text">Title Text</span></a>' +
        '       </h4>' +
        '   </div>' +
        '   <div id="collapseCollapbsible" class="panel-collapse collapse accordion-collapse collapsible-item-collapse" role="tabpanel" aria-labelledby="headingCollapbsible">' +
        '       <div class="panel-body accordion-body collapsible-item-body">Body Text</div>' +
        '   </div>' +
        '</div>';
