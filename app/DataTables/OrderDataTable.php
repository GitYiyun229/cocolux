...
class OrderDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('name'),
            Column::make('tel'),
            Column::make('city_name')->title('Tỉnh/Thành phố')->searchable(false),
            Column::make('district_name')->title('Quận/Huyện')->searchable(false),
            Column::make('address')->title('Địa chỉ')->searchable(false),
            Column::make('note'),
