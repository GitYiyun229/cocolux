...
<!-- Popup banner cứng -->
<div id="popup-banner">
    <a href="https://cocolux.com/blog/cocolux-khoi-dong-chien-dich-can-nang-chill-he-i.2183" target="_blank">
        <img src="https://cocolux.com/storage/upload_image/files/anh-popup.webp" alt="Popup Banner">
    </a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Đóng popup và overlay khi nhấn nút close
        document.querySelector('#popup-banner .close-btn').addEventListener('click', function() {
