                                    ...
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" class="me-2"
                                            ...
                                            <path
                                                ...
                                                stroke="#938D8D" stroke-width="2" stroke-linecap="round"
...
@section('script')
    ...
    <script type='text/javascript'
        src='https://www.bing.com/api/maps/mapcontrol?callback=GetMap&key=Apwotc2pglOqY_bLannByqBGVxp6nHjH6ZGhPsTBOyfdyHbaJZnV87ozNmjKBdlF&mkt=vi-VN'
        async defer></script>
    <script>
        function GetMap() {
            ...
            var map = new Microsoft.Maps.Map(document.getElementById("gmap"), {
                credentials: apiKey
            });
            ...
            map.setView({
                zoom: 7,
                center: new Microsoft.Maps.Location({{ isset($latitude) ? $latitude : '20.90306' }},
                    {{ isset($longitude) ? $longitude : '106.80669' }})
            });
        }
